...
export function chooseMode(ns, rootedServers) {
    ...
    if (augDecision.shouldWorkFaction || augDecision.shouldBuyAugment) {
        return "progression";
    }
...
export function chooseSpendingPolicy(ns, mode, capabilities = {}, overrides = {}) {
    ...
    if (priority === "progression" || mode === "progression") {
        return {
            ...
            // Progression can still buy money-enabling infrastructure,
            // but the individual services must still obey their own reserve checks.
            ...
            allowFactionDonation: augDecision.shouldWorkFaction === true,
